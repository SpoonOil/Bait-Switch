...
function checkCodeValidity(code) {
    var validCodes = ["IVANKOBE", "DEBUG", "IMGAY", "BEEG", "RORY", "BADZOO", "GHOOL", "SHANNONR", "ZOEZAP", "SHRIMP12", "DOH", "JOHNBANG", "GOED", "11101969", "EVYN", "JON", "EMORY", "IANBROWN", "MOUSE", "RISKYSPR", "JACKCRAW", "CRASH", "CANTSPEL", "BADCOST", "WALNUTS", "KASEM", "BIXBY", "YOGI"]
